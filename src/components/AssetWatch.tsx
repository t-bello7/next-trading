...
},
{
  ...
  children: <AssetWatchItem type="indices" />,
    ...
    return (
      ...
      defaultActiveKey="1"
      tabPosition="top"
      className='h-[20vh] md:h-[50vh] w-[45ch] md:w-full [&>.ant-tabs-content-holder]:overflow-scroll rounded-lg font-clashDisplay bg-lightGray dark:bg-darkBlack dark:text-white'
      items={tradingAssets}
      />
    )
};
